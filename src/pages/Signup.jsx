...
const Signup = (props) => {
  ...
  `}</style>
      ...
      <div className="relative text-[#4b4b4b]">
          ...
          <div className='py-5 px-6 box-shadow bg-white rounded-lg'>
            ...
            <div className="text-start mt-[1rem]">
              <p className="text-[.8rem]">
                ...
                information to KikoTalk. By clicking Sign Up/Submit, you agree
                to our Terms,{" "}
                <span className="font-bold underline">Privacy Policy</span> and{" "}
                <span className="font-bold underline">Cookies Policy</span>. You
                may receive SMS Notifications from us and can opt out any time.{" "}
                <br />
                <i>
                  <strong> Charot lang muna to!</strong>
                </i>
              </p>
            </div>
        ...
        m-[0_auto] text-white font-bold text-[1.1rem] ${
          firstName.length && lastName.length >= 2
            ? "pointer-events-auto bg-green"
            : "pointer-events-none bg-green opacity-40"
        } `}
              >
                Submit
              </button>
